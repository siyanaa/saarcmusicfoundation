        ...
        <div class="card-body">
            <div>
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="youtube_link" class="form-control" placeholder="YouTube URL (https://)" id="youtube_link">
                </div>
                
                <div class="form-group">
                    <label for="twitter_link">Twitter URL</label>
                    <input type="url" name="twitter_link" class="form-control" placeholder="Twitter URL (https://)" id="twitter_link">
                </div>
            </div>
        </div>
