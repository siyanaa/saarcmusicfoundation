                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select id="role" class="form-control @error('role') is-invalid @enderror" name="role" required>
                                        ...
                                        <option value="Executive Team" {{ old('role') == 'Executive Team' ? 'selected' : '' }}>Executive Team</option>
                                        <option value="Advisory Team" {{ old('role') == 'Advisory Team' ? 'selected' : '' }}>Advisory Team</option>
